# Generated by Django 4.0.3 on 2022-03-15 18:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='store',
            name='menu',
            field=models.ManyToManyField(related_name='stores', through='store.StoreMenu', to='store.items'),
        ),
        migrations.CreateModel(
            name='ItemRate',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rating', models.DecimalField(decimal_places=1, max_digits=2)),
                ('itemId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store.items')),
            ],
        ),
    ]
